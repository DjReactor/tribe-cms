            ...
            <div className="mt-10 grid grid-cols-2 gap-6">
              {businessInfo.year_established > 0 && (
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-100">
                  <div className="text-3xl font-bold text-[var(--color-accent)] mb-2">{businessInfo.year_established}</div>
              ...
              {businessInfo.employee_count && (
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-100">
                  <div className="text-3xl font-bold text-[var(--color-accent)] mb-2">{businessInfo.employee_count}</div>
              ...
              <div className="bg-gray-50 rounded-2xl p-8 border border-gray-100">
                ...
                <ul className="grid grid-cols-2 gap-3">
                  {serviceAreas.map((area) => (
                    <li key={area.id}>
                      <Link href={`/${area.slug}`} className="text-gray-600 hover:text-[var(--color-accent)] font-medium flex items-center gap-2">
