        ...
        <div>
          ...
          <div className="flex gap-4 mb-8">
            {businessInfo.social_facebook && (
              <a href={businessInfo.social_facebook} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                Facebook
              </a>
            )}
            {businessInfo.social_instagram && (
              <a href={businessInfo.social_instagram} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                Instagram
              </a>
            )}
            {businessInfo.social_google && (
              <a href={businessInfo.social_google} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                Google
              </a>
            )}
            {businessInfo.social_yelp && (
              <a href={businessInfo.social_yelp} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                Yelp
              </a>
            )}
            {businessInfo.social_other && (
              <a href={businessInfo.social_other} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                Other
              </a>
            )}
          </div>
