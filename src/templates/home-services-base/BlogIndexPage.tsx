              ...
              {posts?.map((post) => (
                ...
                >
                  ...
                  <div className="p-8 flex flex-col flex-1">
                    {post.published_at && (
                      <div className="text-sm font-semibold text-[var(--tribe-brand)] mb-4">
                        {formatDate(post.published_at)}
                      </div>
                    )}
                    <h2 className="font-heading font-bold text-2xl text-gray-900 mb-4 group-hover:text-[var(--tribe-brand)] transition-colors">
                      {post.title}
                    </h2>
                    {post.excerpt && (
                    ...
                    <div className="mt-auto flex items-center gap-2 font-medium text-gray-900 group-hover:text-[var(--tribe-brand)] transition-colors">
                      Read Article
