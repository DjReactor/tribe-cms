      ...
      <section className="relative w-full h-[40vh] min-h-[350px] flex items-center pt-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-center">
          <div className="max-w-3xl mx-auto">
            <h1 className="text-4xl md:text-5xl font-heading font-bold text-[var(--tribe-text)] leading-tight mb-4">
            ...
            <div className="flex items-center justify-center text-sm font-medium text-gray-400">
              ...
              <span className="text-[var(--tribe-brand)]">Blog</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {posts && posts.length > 0 ? (
              posts.map((post) => (
                <article key={post.id} className="bg-[var(--tribe-surface)] rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-shadow border border-gray-100 flex flex-col h-full group">
                  <div className="relative h-64 overflow-hidden">
                    ...
                    />
                    {post.category && (
                      <div className="absolute top-4 left-4 bg-[var(--tribe-brand)] text-gray-900 text-xs font-bold px-3 py-1 rounded-full">
                        {post.category}
                      </div>
                    )}
                  </div>
              ...
              // Empty State
              <div className="col-span-full py-20 text-center bg-[var(--tribe-surface)] rounded-3xl border border-gray-200 border-dashed">
