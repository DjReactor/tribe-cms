        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-2xl">
            ...
            <div className="flex items-center text-sm font-medium text-gray-400">
              ...
              <span className="text-[var(--tribe-brand)]">Service Areas</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
                ...
                {serviceAreas && serviceAreas.length > 0 ? (
                  serviceAreas.map((area, idx) => (
                    <div key={idx} className="bg-gray-50 rounded-xl p-4 border border-gray-100 flex items-center shadow-sm">
                      <svg className="w-5 h-5 text-[var(--tribe-brand)] mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
              ...
              <div className="bg-[#0A1A12] rounded-3xl p-8 shadow-xl text-[var(--tribe-text)] relative overflow-hidden">
                ...
                <div className="relative z-10 flex items-center">
                  <div className="w-10 h-10 rounded-full bg-[var(--tribe-brand)] flex items-center justify-center mr-4 text-gray-900">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-[var(--tribe-surface)] rounded-3xl p-8 border border-gray-100 shadow-sm">
