        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-2xl">
            ...
            <div className="flex items-center text-sm font-medium text-gray-400">
              ...
              <span className="text-[var(--tribe-brand)]">About</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="flex space-x-8 border-b border-gray-200 mb-6">
                <button className="pb-4 border-b-2 border-[var(--tribe-brand)] text-gray-900 font-bold text-lg">Our Values</button>
              ...
              <Link href="/services" className="inline-flex items-center text-gray-900 font-bold hover:text-[var(--tribe-brand)] transition-colors">
                View Services
      ...
      <section className="py-20 bg-[var(--tribe-surface)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="bg-gray-900 rounded-3xl p-8 md:p-16 flex flex-col lg:flex-row items-center justify-between gap-12 shadow-2xl relative overflow-hidden">
             <div className="absolute top-0 right-0 w-64 h-64 bg-[var(--tribe-brand)] rounded-full filter blur-[100px] opacity-20"></div>
             
             <div className="lg:w-1/2 relative z-10 text-[var(--tribe-text)]">
                ...
                <div className="space-y-6">
                  <div className="flex items-center">
                    <div className="w-12 h-12 rounded-full bg-[var(--tribe-surface)]/10 flex items-center justify-center mr-4 text-[var(--tribe-brand)]">
             ...
             <div className="lg:w-1/2 w-full relative z-10">
                <div className="bg-[var(--tribe-surface)] rounded-2xl p-8 shadow-xl">
                  <h3 className="text-xl font-bold text-gray-900 mb-6 flex items-center">
                    <svg className="w-5 h-5 text-[var(--tribe-brand)] mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                    Business Hours
                  </h3>
