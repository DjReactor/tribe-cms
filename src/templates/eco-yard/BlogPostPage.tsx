...
export function BlogPostPage({
  ...
  return (
    <div className="w-full bg-[var(--tribe-surface)]">
      {/* Blog Post Header */}
      <section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        {post.category && (
          <div className="inline-block bg-[var(--tribe-brand)] text-gray-900 text-xs font-bold px-3 py-1 rounded-full mb-6">
            {post.category}
          </div>
        )}
      ...
      <section className="px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto pb-24">
        <div 
          className="prose prose-lg prose-gray max-w-none prose-headings:font-heading prose-headings:font-bold prose-a:text-[#0C1810] prose-a:font-bold hover:prose-a:text-[var(--tribe-brand)] prose-img:rounded-2xl"
        ...
        <div className="mt-16 pt-8 border-t border-gray-200">
          <div className="bg-gray-50 rounded-2xl p-8 text-center sm:text-left sm:flex items-center justify-between">
            ...
            <Link href="/contact" className="inline-block bg-gray-900 hover:bg-gray-800 text-[var(--tribe-text)] rounded-full px-8 py-3 font-medium transition-colors whitespace-nowrap">
              Get a Quote
            </Link>
          </div>
        </div>
